...
export class Backend implements backendInterface {
    ...
    async getMySettings(): Promise<UserSettings> {
        if (this.processError) {
            try {
                const result = await this.actor.getMySettings();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async saveUserSettings(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveUserSettings(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
